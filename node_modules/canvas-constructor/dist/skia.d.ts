...
/// <reference lib="dom" />
import { Canvas as SkiaCanvas, CanvasRenderingContext2D as SkiaCanvasRenderingContext2D, Font, FontLibrary, Image as SkiaImage, loadImage, Path2D } from 'skia-canvas';
...
export declare class Canvas extends BaseCanvas<SkiaCanvas, SkiaCanvasRenderingContext2D> {
     ...
     */
    getPages(): SkiaCanvasRenderingContext2D[];
    /**
...
export declare function registerFont(familyName: string, fontPaths?: string | readonly string[]): Font[];
export declare function registerFont(fontPaths: readonly string[]): Font[];
export declare function registerFont(families: Record<string, readonly string[] | string>): Record<string, Font[] | Font>;
